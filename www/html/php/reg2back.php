...
if(!($result = mysql_query($query, $dbLink))) {
   ...
   if ($num_rows==0) {
      ...
      $query="INSERT INTO member (fullName, email, password, groups) VALUES ('$fullName', '$email', '$password', '$groups')";
...
$msg="You have successfully registered.  Please use the following link to enter member only area. <a href=\"http://chow.csnet.uccs.edu/secure2/$groups/\">http://chow.csnet.uccs.edu/secure/$gropus/</a>.";
$to=$email;
