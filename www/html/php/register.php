...
$msg="You have successfully registered.  Please use the following link to enter member only area. <a href=\"http://$domain/secure/\">http://$domain/secure/</a>.";
$to=$email;
...
$cmd = "echo \"$msg\" | /usr/bin/mail -s '$subject' $to cchow@uccs.edu";
system($cmd);
print "cmd=$cmd\n";
