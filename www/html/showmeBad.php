...
<tr><td>Email:</td><td><input type="text" size="50" name="email" value="cchow@uccs.edu"></td></tr>
<tr><td>
Password:</td><td><input type="password" name="passwd" size="50" value="1234"></td></tr>
