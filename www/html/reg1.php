...
<form method="POST" autocomplete="on" name="form1"
      action="https://<?php echo $_SERVER['HTTP_HOST'] ?>/php/reg1.php">
<tr><td>Full Name:</td>
<td>
...
<input type="text" name="emailConfirmed" size="50" 
       value="cchow@uccs.edu" >
</td></tr>  
...
<input type="password" name="passwordConfirmed" required="required"  size="50" value="1111" >
</td></tr>  
</table>
